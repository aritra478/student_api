<section id=features class="pt-20 dark:bg-dark lg:pt-[120px] bg-gradient-to-r from-slate-100 to-slate-100">
        ...
        <div class="-mx-4 flex flex-wrap">
            <div class="w-full px-4">
                <div class="mx-auto mb-12  text-center lg:mb-20">
                    ...
                    <h2
                        class="mb-3 text-3xl font-bold leading-[1.2] text-dark dark:text-white sm:text-4xl md:text-[40px]" data-wow-delay=0.3s>
                        Learn More About Us
                    </h2>
                    <p class="dark:text-dark-6 text-base text-body-color">
                        The Unified Project Management System (UPMS) provides a comprehensive platform for managing projects from inception to completion. It enables the preparation, approval, and monitoring of projects seamlessly. With UPMS, users can view and track the physical and financial progress of projects in real time, ensuring timely and informed decision-making. The system standardizes methodologies and workflows across all works departments of the Government of West Bengal (GoWB), promoting consistency and efficiency. Additionally, UPMS offers a digital platform for creating and accessing essential project documents, including Schedule of Rates (SOR), Bills of Quantities (BOQ), estimations, tenders, and payments, centralizing project information for enhanced transparency and accessibility.
                    </p>
                </div>
            </div>
        </div>
        <div class="-mx-4 flex flex-wrap">
            <div class="w-full px-4 md:w-1/2 xl:w-1/4">
                <div class="relative mx-auto mb-10 max-w-[370px] text-center">
                    <div
                        class="absolute -right-4 top-12 hidden h-1 w-16 border-t-2 border-dashed border-blue-500 xl:block 2xl:w-[75px]">
                    </div>
                    <div
                        class="relative mx-auto mb-8 flex h-[100px] w-[100px] items-center justify-center rounded-[20px] bg-blue-600 text-white">
                    ...
                    <p class="dark:text-dark-6 text-base text-body-color">
                        Our platform is user-friendly, intuitive, and designed for seamless navigation, ensuring efficiency and ease for all users.
                    </p>
                </div>
            </div>
            <div class="w-full px-4 md:w-1/2 xl:w-1/4">
                <div class="relative mx-auto mb-10 max-w-[370px] text-center">
                    <div
                        class="absolute -left-4 top-12 hidden h-1 w-16 border-t-2 border-dashed border-blue-500 xl:block 2xl:w-[75px]">
                    </div>
                    <div
                        class="absolute right-[-14px] top-12 hidden h-1 w-16 border-t-2 border-dashed border-blue-500 xl:block 2xl:w-[75px]">
                    </div>
                    <div
                        class="mx-auto mb-8 flex h-[100px] w-[100px] items-center justify-center rounded-[20px] bg-blue-600 text-white">
                        <svg width="44" height="44" viewBox="0 0 44 44" fill="none"
                            xmlns="http://www.w3.org/2000/svg" class="fill-current">
                            <path
                    ...
                    <p class="dark:text-dark-6 text-base text-body-color">
                        Our design is visually stunning, modern, and crafted to enhance user engagement and satisfaction.
                    </p>
                </div>
            </div>
            <div class="w-full px-4 md:w-1/2 xl:w-1/4">
                <div class="relative mx-auto mb-10 max-w-[370px] text-center">
                    ...
                    <p class="dark:text-dark-6 text-base text-body-color">
                        Our platform offers extensive customization options, allowing you to tailor features to your specific needs effortlessly.
                    </p>
                </div>
            </div>
            <div class="w-full px-4 md:w-1/2 xl:w-1/4">
                <div class="relative mx-auto mb-10 max-w-[370px] text-center">
                    <div
                        class="absolute left-[-14px] top-12 hidden h-1 w-16 border-t-2 border-dashed border-blue-500 xl:block 2xl:w-[75px]">
                    </div>
                    <div
                        class="mx-auto mb-8 flex h-[100px] w-[100px] items-center justify-center rounded-[20px] bg-blue-600 text-white">
                        <svg width="44" height="44" viewBox="0 0 44 44" fill="none"
                    ...
                    <p class="dark:text-dark-6 text-base text-body-color">
                        Our support team is available 24/7 to assist with any issues or questions, ensuring you’re always covered.
                    </p>
                </div>
            </div>
        </div>
